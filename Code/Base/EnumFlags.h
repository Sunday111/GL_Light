...
#define _ENUM_FLAG_OPERATORS(PREFIX, ET_) \
...
#define ENUM_FLAG_OPERATORS(ET_) \
    _ENUM_FLAG_OPERATORS(inline, ET_)

#define ENUM_FLAG_OPERATORS_CLASS(ET_) \
    _ENUM_FLAG_OPERATORS(friend inline, ET_)
